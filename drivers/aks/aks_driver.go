...
type state struct {
	...
	*/
	...
	// loadBalancerSku specifies the loadBalancer  Sku of the cluster. [optional]
...
func (d *Driver) GetDriverCreateOptions(ctx context.Context) (*types.DriverFlags, error) {
	...
	driverFlag.Options["load-balancer-sku"] = &types.Flag{
		Type:  types.StringType,
		Usage: "The loadBalancer sku of the cluster in the Rancher UI.",
		Value: string(containerservice.Basic),
	}
